...
std::string multiplechoiceknapsacksolver::get_path(
...
std::vector<TestInstancePath> multiplechoiceknapsacksolver::get_test_instance_paths(
...
std::vector<TestParams> multiplechoiceknapsacksolver::get_test_params(
...
const Instance multiplechoiceknapsacksolver::get_instance(
...
const Solution multiplechoiceknapsacksolver::get_solution(
